layui.define(["element", "jquery"], function (exports) {
    ...
    layuimini = new function () {
        ...
        this.initHome = function (data) {
            sessionStorage.setItem('layuiminiHomeHref', "resources/page/welcome-1.html?t=1");
            $('#layuiminiHomeTabId').html('<i class="fa fa-home"></i> <span>工作台</span>');
            $('#layuiminiHomeTabId').attr('lay-id', "resources/page/welcome-1.html?t=1");
            $('#layuiminiHomeTabIframe').html('<iframe width="100%" height="100%" frameborder="0"  src="resources/page/welcome-1.html?t=1"></iframe>');
        };
